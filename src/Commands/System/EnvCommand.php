        ...
        $this->setName(self::ROUTE)
            ...
            ->setHelp(
                r(
                    ...
                    * The key MUST be in CAPITAL LETTERS. For example [<flag>{PF}CRON_IMPORT</flag>].
                    * The key MUST start with [<flag>{PF}</flag>]. For example [<flag>{PF}CRON_EXPORT</flag>].
                    ...
                    * The key SHOULD attempt to mirror the key path in default config, If not applicable or otherwise impossible it
                    ...
                    To load container specific variables i,e, the keys that does not start with <comment>{PF}</comment> prefix,
