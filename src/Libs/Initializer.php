...
final class Initializer
{
    ...
    public function __construct()
    {
        ...
        (function () {
            ...
            $dataPath = env('DATA_PATH', fn() => inContainer() ? '/config' : __DIR__ . '/../../var');
    ...
    private function createDirectories(): void
    {
        ...
        if (!($path = Config::get('path'))) {
            throw new RuntimeException('No ENV:DATA_PATH was set.');
        }

        if (!($tmpDir = Config::get('tmpDir'))) {
            throw new RuntimeException('No ENV:TMP_DIR was set.');
        }
